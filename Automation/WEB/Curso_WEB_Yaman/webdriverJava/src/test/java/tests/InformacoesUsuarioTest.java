...
//  }
  ...
  @Test
  public void adicionarTelefoneDoUsuario() {
    navegador.findElement(By.xpath("//button[@data-target=\"addmoredata\"]")).click();
    WebElement popupAddMoreData = navegador.findElement(By.id("addmoredata"));

    new Select(popupAddMoreData.findElement(By.name("type"))).selectByValue("phone");

    popupAddMoreData.findElement(By.name("contact")).sendKeys("+5500987654321");
    popupAddMoreData.findElement(By.linkText("SAVE")).click();

    WebElement mensagemTelefoneAdicionado = navegador.findElement(By.id("toast-container"));
    Assert.assertEquals("Your contact has been added!", mensagemTelefoneAdicionado.getText());
